...
{
    executor_task_wrapper_t *ctx =
        (executor_task_wrapper_t *)arg;
...
static error_t executor_submit(executor_interface_t *exec,
                               void (*fn)(void *),
                               void *arg)
{
    ...
    executor_task_wrapper_t *ctx =
        malloc(sizeof(executor_task_wrapper_t));
...
error_t executor_create(const cleaner_platform_api_t *platform,
                        int threads,
                        executor_interface_t **out_exec)
{
    ...
    executor_internal_t *internal =
        malloc(sizeof(executor_internal_t));
    ...
    executor_interface_t *iface =
        malloc(sizeof(executor_interface_t));
